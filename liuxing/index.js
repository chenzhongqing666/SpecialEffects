...
const fatherDom1 = document.getElementsByClassName('father1')[0]
const fatherDom2 = document.getElementsByClassName('father2')[0]
...
function createDom() {
    const meteor1 = new Meteors({
        width: createRandom(setLong*0.46, setLong*0.16),
        height: createRandom(setLong*0.16, 10),
...
function createGaussDom() {
    const long1 = createRandom(setLong*0.05, setLong*0.02)
    ...
    const long2 = createRandom(setLong*0.05, setLong*0.02)
